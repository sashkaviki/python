...
как произведение количества ячеек этих двух клеток. Деление. Создается общая клетка из двух.
...
class Cell:
    ...
    def make_order(self, qty):
        result = ''
        for i in range(self.quantity // qty):
            result += f'{"*" * qty}\\n'
        return result + f'{"*" * (self.quantity % qty)}'
...
cell4 = cell1 * cell2
cell5 = cell1 / cell2
print(f'Сложение:', cell3.quantity)
print(f'Вычетание:', cell1 - cell2)
print(f'Умножение:', cell4.quantity)
print(f'Деление:', cell5.quantity)
